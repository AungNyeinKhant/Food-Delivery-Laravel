                ...
                <div class="card mb-3 mb-lg-5">
                    ...
                    <div class="table-responsive">
                        ...
                        <div class="row justify-content-end mb-3 px-4">
                             @if($order->kpay_transition || $order->kpay_image) 
                            <div class="col-md-6 col-lg-5 initial-39-3">
                                <dl class="row text-sm-right">
                                    ...
                                    <dd class="col-6 text-right">
                                        {{ $order->kpay_transition }}
                                        <hr>
                                    </dd>
                                    <dt class="col-12 text-center">{{ translate('messages.transition_image') }}:</dt>
                                    <div class="col-12 text-center">
                                        <a target="_blank" href="{{ asset('storage/app/public/onlinepayments/' . $order->kpay_image) }}" >
                                            <img class="img-fluid" src="{{ asset('storage/app/public/onlinepayments/' . $order->kpay_image) }}" alt="Transition SS">
                                        </a>
                                    </div>
                                </dl>
                            </div>
