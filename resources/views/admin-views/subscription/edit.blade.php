            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="check--item-wrapper mt-0">
                        ...
                        <!--Other staus start by ANK 12.3.2024-->
                        {{-- --}}
                        <div class="check-item">
                            <div class="form-group form-check form--check">
                                <input type="checkbox" name="delivery" value="1" class="form-check-input"
                                    {{ $package->delivery == 1 ? 'checked' : '' }} id="delivery">
                                <label class="form-check-label ml-2 ml-sm-3    text-dark"
                                    for="delivery">{{ translate('messages.home_delivery') }}</label>
                            </div>
                        </div>
                        
                        <div class="check-item">
                            <div class="form-group form-check form--check">
                                <input type="checkbox" name="take_away" value="1" class="form-check-input"
                                    {{ $package->take_away == 1 ? 'checked' : '' }} id="take_away">
                                <label class="form-check-label ml-2 ml-sm-3    text-dark"
                                    for="take_away">{{ translate('messages.takeaway') }}</label>
                            </div>
                        </div>

                        <div class="check-item">
                            <div class="form-group form-check form--check">
                                <input type="checkbox" name="dine_in" value="1" class="form-check-input"
                                    {{ $package->dine_in == 1 ? 'checked' : '' }} id="dine_in">
                                <label class="form-check-label ml-2 ml-sm-3    text-dark"
