                    ...
                    <div class="form-group mb-0">
                        <label class="toggle-switch toggle-switch-sm d-flex justify-content-between border  rounded px-3 form-control" for="dine_in">
                            <span class="pr-2 d-flex">
                                ...
                                <span  data-toggle="tooltip" data-placement="right" data-original-title="{{translate('When_enabled,_customers_can_make_dine_in_orders_from_this_restaurant.')}}" class="input-label-secondary">
                                    <i class="tio-info-outined"></i>
                                </span>
                            </span>
                            <input type="checkbox" name="dine_in" class="toggle-switch-input"

                            onclick="toogleStatusModal(event,'dine_in','dm-self-reg-on.png','dm-self-reg-off.png','{{translate('Want_to_enable_dine_in_for_this_restaurant?')}}','{{translate('Want_to_disable_dine_in_for_this_restaurant?')}}',`<p>{{translate('If_enabled,_the_dine_in_feature_will_be_available_for_the_restaurant’s_items.')}}</p>`,`<p>{{translate('If_disabled,_the_dine_in_feature_will_be_hidden_from_this_restaurant’s_items.')}}</p>`)"
                        ...
                        <form action="{{route('admin.restaurant.toggle-settings',[$restaurant->id,$restaurant->dine_in?0:1, 'dine_in'])}}" method="get" id="dine_in_form">
                        </form>
                    </div>
                </div>
