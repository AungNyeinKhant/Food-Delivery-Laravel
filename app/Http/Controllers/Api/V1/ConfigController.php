...
class ConfigController extends Controller
{
    ...
    {
        $key = [
            'cash_on_delivery', 'digital_payment','online_payment', 'default_location',  'free_delivery_over', 'business_name', 'logo', 'address', 'phone', 'email_address', 'country', 'currency_symbol_position', 'app_minimum_version_android',
        ...
        $digital_payment_infos = array(
         ...
         $online_payment = json_decode($settings['online_payment'], true);
        ...
        return response()->json([
            ...
            'online_payment' => (bool)($online_payment['status'] == 1 ? true : false),
