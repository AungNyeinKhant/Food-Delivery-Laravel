...
class OrderController extends Controller
{
    public function list($status , Request $request)
    {
        ...
        ->orderBy('id', 'desc')// ->orderBy('schedule_at', 'desc')
    ...
    public function status(Request $request)
    {
        ...
        if($request['order_status']=='canceled' && $order->confirmed)
        {
         ...
         if($request->order_status == 'canceled' && $order->payment_status =='paid' && $order->payment_method == 'wallet'){
                CustomerLogic::create_wallet_transaction($order->user_id, $order->order_amount, 'order_refund','order_wallet_refund' );
